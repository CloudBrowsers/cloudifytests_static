    ...
    <Container id="offerings">
      <div className="container">
        <div data-aos="zoom-in">
          ...
          {/* <h4>Offerings</h4> */}
          {/* <p>
            Our proprietary tools deliver efficient and cost-effective manual
            and automated testing solutions.
          </p> */}
          <Grid className="offering_data">
            <div className="data">
              <Link
                activeClass="active"
                to={"dashboard"}
        ...
        <div className="offering_container" id="session">
          <div
            className="right_container"
            data-aos="flip-right"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000"
          >
            <img src={session} alt="sessions" className="img" />
          </div>
        ...
        <div className="offering_container" id="script">
          <div className="left_container" data-aos="fade-up">
          ...
          <div
            ...
            data-aos-duration="2000"
          >
            <img src={capabilities} alt="capabilities" className="img" />
          </div>
        </div>
        <div className="offering_container" id="historySession">
          <div
            className="right_container"
            data-aos="flip-right"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="2000"
          >
            <img src={historySession} alt="historySession" className="img" />
          </div>
        ...
        <div className="offering_container">
          ...
          <div
            ...
            data-aos-duration="2000"
          >
            <img src={tunnel} alt="dashboard" className="img" />
          </div>
        </div>
      </div>
    </Container>
